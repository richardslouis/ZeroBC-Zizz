...
<html>
	<head>
		...
		<meta http-equiv="refresh" content="7; url=app.php" />
			...
			<ul id="scene" class="scene">
				...
				<li class="layer" data-depth="0.60">
					<div class="content"><br>
						<p style="text-align:center;color:white"><button class="btn btn-light btn-rounded main-font" disabled><font style="color:white;">Sponsored</font></button> | <button class="btn btn-light btn-rounded main-font" onclick="location.href='app.php'"><a href="app.php"><font style="color:#ffd433;">Skip>></font></a></button></p>
							<b><font style="color:white;text-align:center;"><div align="center" id="numberCountdown"></div></font></b>
							  <div style="align:center">
								...
								document.write("<img style='display:block;margin:0 auto;height:70vh;max-width:100%;' src='" + imlocation + randomimage()+ "'>");
									//-->
								</script>
							</div>
